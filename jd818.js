...
const helpCode = ['11ca48ca-ca3f-42e8-b4fe-ced73e7cafde', 'd2807c78-1542-476f-9254-5410f3a288de', '75caf1bb-2c2a-4a9e-a5db-a2b938053761', 'c12d8d30-fe86-4b24-88df-02826dccab4d', '55e93f88-d20c-4abc-82e3-c7ca66bd6131'];
!(async () => {
  if (!cookiesArr[0]) {
...
function showMsg() {
  if (Date.now() > new Date(activeEndTime).getTime()) {
    $.msg($.name, '活动已结束', `请禁用或者删除此脚本\n如果帮助到您可以点下🌟STAR鼓励我一下,谢谢\n咱江湖再见\n `, {"open-url": "https://github.com/sngxpro/QuantumultX"});
  } else {
